    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http.csrf().disable()
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/wharves/**").hasAnyAuthority("ROLE_WAREHOUSE","ROLE_ADMIN","ROLE_MAINTAINER")
                        .requestMatchers("/api/deliveries/**").hasAnyAuthority("ROLE_WAREHOUSE", "ROLE_ADMIN")
                        .requestMatchers("/api/terminals/**").hasAnyAuthority("ROLE_HANDLER", "ROLE_ADMIN","ROLE_WAREHOUSE")
                        .requestMatchers("/api/employees/**").hasAnyAuthority("ROLE_ADMIN")
                        .requestMatchers("/api/ports/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_HANDLER","ROLE_WAREHOUSE","ROLE_MAINTAINER")
